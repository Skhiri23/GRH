		...
		<table class="table table-striped mt-3">
			...
			<tbody>
				...
				<tr>
					...
					<td>
    <?php
     $statut_poste = $r['statut_poste'];

     if ($statut_poste == 'Inactif') {
         echo '<button class="btn btn-secondary" disabled>Postuler</button>';
    } else {
         echo '<button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#postulerModal' . $r['id'] . '">Postuler</button>';
    }
    ?>

    <div class="modal fade" id="postulerModal<?php echo $r['id']; ?>" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    <p>Êtes-vous sûr de vouloir postuler à ce Poste ?</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Annuler</button>
                    <a href="candidat_form.php?post_id=<?php echo $r['id']; ?>">
