        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav m-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="listedespostevacant.php">Liste des Poste Vacant</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../../../candidat/login-form-v1/Login_v1/login_candidat.php">Espace Candidature</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../../../Login_v1/index.php">Portail Entreprise</a>
                    </li>
                </ul>
            </div>
        </div>
